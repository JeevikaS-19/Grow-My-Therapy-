...
const FinalCTA: React.FC<Props> = ({ onNavigate }) => {
  return (
    <section className="py-48 px-10 bg-[#4D5842] text-[#FAF8F6] text-center">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-6xl md:text-[6.5rem] serif-font mb-14 leading-[1.05] italic font-light">Get started today.</h2>
