...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#FAF8F6] pt-40 pb-16 px-10">
      <div className="max-w-[1440px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-24 mb-32">
          <div className="flex flex-col">
            ...
            <div className="space-y-4 text-base font-light text-[#333333]/60 leading-relaxed">
          ...
          <div>
            <h4 className="text-2xl md:text-4xl serif-font mb-12 text-[#4D5842] font-light italic">Hours</h4>
            <div className="text-base font-light text-[#333333]/60 space-y-3">
              <p>Monday – Friday</p>
              <p>10am – 6pm</p>
            </div>
          </div>
        ...
        <div className="border-t border-[#4D5842]/10 pt-16 flex flex-col md:flex-row justify-between items-center gap-10 text-[10px] uppercase tracking-[0.2em] text-[#333333]/40">
          <div className="flex flex-wrap justify-center gap-10 underline underline-offset-4 decoration-transparent hover:decoration-[#4D5842]/20">
