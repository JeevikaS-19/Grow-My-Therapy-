  ...
  return (
    <section className="pt-10 pb-16 px-10 max-w-[1440px] mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-32">
      <div className="w-full md:w-1/2 flex justify-center animate-fade-in order-2 md:order-1">
        <div className="relative w-full max-w-[480px] aspect-[4/6] arched-image overflow-hidden shadow-[0_30px_90px_-15px_rgba(0,0,0,0.12)] bg-white border border-[#2c3f70]/5 flex items-center justify-center text-center">
          <span className="text-4xl text-[#2c3f70]/20 serif-font italic">img1</span>
        </div>
      </div>
